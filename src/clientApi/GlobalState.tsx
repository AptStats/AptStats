...
import { networks, defaultNetworkName, NetworkName, features, defaultFeatureName, FeatureName } from './constants'
...
function reducer(state: GlobalState, newValue: GlobalState): GlobalState {
  if (typeof window !== 'undefined') {
    ...
    if (newValue.feature_name) {
      localStorage.setItem('selected_feature', newValue.feature_name.toLowerCase())
    }
  }
